    ...
    <div class="wrapper">
      <div class="iq-sidebar  sidebar-default ">
          <div id="sidebar-scrollbar">
              ...
              <div class="iq-top-navbar fixed-top">
              ...
              <nav class="navbar navbar-expand-lg navbar-light p-0">
                  ...
                  <div class="iq-search-bar device-search">
                      <form action="#" class="searchbox">
                          ...
                          <input type="text" class="text search-input" placeholder="Search here/SocialV_App_1.">
                      </form>
                  </div>
                          ...
                          <li class="nav-item dropdown">
                           ...
                           <li class="nav-item dropdown">
                              <a href="#" class="   d-flex align-items-center dropdown-toggle" id="drop-down-arrow" data-bs-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
                                  <img src="/assets/images/user/09.jpg" class="img-fluid rounded-circle me-3" alt="user">
                                  <div class="caption">
                              ...
                              <div class="sub-drop dropdown-menu caption-menu" aria-labelledby="drop-down-arrow">
                                  <div class="card shadow-none m-0">
                                      ...
                                      <div class="card-body p-0 ">
                                          ...
                                          <a href="profile-edit.php" class="iq-sub-card iq-bg-warning-hover">
                                              <div class="d-flex align-items-center">
                                          ...
                                          <a href="account-setting.php" class="iq-sub-card iq-bg-info-hover">
                                              <div class="d-flex align-items-center">
                                          ...
                                          <a href="privacy-setting.php" class="iq-sub-card iq-bg-danger-hover">
                                              <div class="d-flex align-items-center">
